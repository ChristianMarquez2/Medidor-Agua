...
Aplicación móvil híbrida desarrollada con **Ionic (Angular)** para digitalizar y validar el proceso de lectura de medidores de agua en el **Distrito Metropolitano de Quito**.  
Su objetivo es reemplazar el registro manual en papel por un sistema digital confiable, seguro y con evidencia geográfica y fotográfica.
...
``bash
git clone https://github.com/ChristianMarquez2/Medidor-Agua
cd tu-repositorio
